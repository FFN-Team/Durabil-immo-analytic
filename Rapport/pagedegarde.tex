...
\newgeometry{top=2.5cm, bottom=1cm, left=1cm, right=1cm}
\AddToShipoutPicture*{}
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
    ...
    \vspace{0.5cm}
    {\bfseries Projet Durabil'immo}\\
    %	{\Large{\bfseries Spécialité doctorale ``\@specialite''}}\\
    \vspace{2cm}
    	\textit{présenté et soutenu par}\\
    \vspace{0.3cm}
    	{\Large {\bfseries Florine PHILIPPE }} \\
    \vspace{0.3cm}
	{\Large {\bfseries Niraiksan RAVIMOHAN }} \\
    \vspace{0.3cm}
	{\Large {\bfseries Fanuel MEHARI }} \\
    \vspace{0.3cm}
    	le \@date \\
    \vfill
